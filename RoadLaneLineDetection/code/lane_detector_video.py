...
def region_of_interest(image, vertices):
    ...
    #retrive number of color channel
    #color_channel_count = image.shape[2]
...
#read the video
captured_video = cv2.VideoCapture('/Users/atharvapore/Desktop/Masters/Projects/OpenCV/RoadLaneLineDetection/test_video.mp4')
